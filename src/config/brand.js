// Cấu hình thương hiệu tập trung (docs/thiet-ke.md mục 3).
// DISPLAY_NAME dùng ở mọi nơi hiển thị tên sản phẩm cho người dùng (TopBar, tiêu đề).
...
export const DISPLAY_NAME = 'Capix'
export const LEGAL_NAME = 'Công ty Capix'
